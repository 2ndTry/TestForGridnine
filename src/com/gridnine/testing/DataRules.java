...
class DateRules implements Filterable {
    ...
    public void allFlights(List<Flight> flightList) {
    ...
    @Override
    public void ruleOfDepartureToCurrentMoment(List<Flight> flightList) {
    ...
    @Override
    public void ruleOfSegmentsArrivalDateEarlier(List<Flight> flightList) {
    ...
    public int different(LocalDateTime dateTime1, LocalDateTime dataTime2){
        return (int) ChronoUnit.HOURS.between(dateTime1,dataTime2);
    }

    @Override
    public void ruleOfTimeOnEarth(List<Flight> flightList) {
